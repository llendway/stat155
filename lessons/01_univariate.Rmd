...
<center>
![](images/moderndive_flowchart_explore.png){width="50%"}
</center>
...
* You can watch a [short video](https://youtu.be/K1SuD43INLQ) of me using the `palmerpenguins` dataset to do some plotting and summarizing of quantitative variables. You can download the files to follow along below. Save these files as you'll use them in the next section too.

```{r, echo=FALSE}
library(downloadthis)
download_file(
  path = "../demos/univariate_no_code.Rmd",
...
```{r, echo=FALSE}
download_file(
  path = "../demos/univariate_code.Rmd",
...
* Watch a short [video](https://youtu.be/KVGkeWUIKR0) of me doing a couple examples of plotting and summarizing with categorical data. The files to follow along are in the previous section.

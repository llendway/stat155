...
* You can watch a [short video](https://youtu.be/K1SuD43INLQ) of me using the `penguins` dataset to do some plotting and summarizing of quantitative variables. You can download the files to follow along below. Save these files as you'll use them in the next section too.

```{r, echo=FALSE}
library(downloadthis)
download_file(
  path = "../demos/00_univariate_no_code.Rmd",
...
```{r, echo=FALSE}
download_file(
  path = "../demos/00_univariate_code.Rmd",

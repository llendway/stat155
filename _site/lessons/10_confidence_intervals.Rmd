...
3. Construct a 95% confidence interval using the SE you found from the boostrap distribution. (Remove `eval=FALSE` when finished)
...
This standard error is computed using some statistical theory (for reference, see [Heggeseth/Myint](https://bcheggeseth.github.io/Stat155Notes/confidence-intervals.html)). That is used in constructing the confidence interval. 
